...
begin
  dmConexao.qryVendas.Append;
  dmConexao.qryVendas.FieldByName('data_venda').AsDateTime := Date;
end;

procedure TfrmVendas.Salvar;
begin
  if dmConexao.qryVendas.State in [dsInsert, dsEdit] then
    dmConexao.qryVendas.Post;
end;
